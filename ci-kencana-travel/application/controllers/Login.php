...
class Login extends CI_Controller {
	...
	Private function _sendmail($token='',$type=''){
		$config = [
               ...
               'smtp_user' => 'kencanavel@gmail.com',    // Ganti dengan email gmail kamu
               'smtp_pass' => '06064kencanA',      // Password gmail kamu
               'smtp_port' => 465,
               'crlf'      => "rn",
               'newline'   => "rn"
           ];
        ...
        $this->email->from('KENCANA TRAVEL');
        $this->email->to($this->input->post('email'));
        // $this->email->attach('https://masrud.com/content/images/20181215150137-codeigniter-smtp-gmail.png');
        if ($type == 'verify') {
        	$this->email->subject('Account verify Kencana Travel');
        	...
        	$this->email->subject('Akun Reset Kencana Travel');
