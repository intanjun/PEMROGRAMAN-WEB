      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">             
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <p>Travel    : <b> <?php echo $jadwal['kd_bus']." [".$jadwal['nama_bus'].'-'.$jadwal['plat_bus'] ?>]</b></p>
			...
			<button type="button" class="btn btn-danger pull-right" data-toggle="modal" data-target="#ModalTujuan">Hapus</button>
          </div>
      </div>
    </div>
  </div>
