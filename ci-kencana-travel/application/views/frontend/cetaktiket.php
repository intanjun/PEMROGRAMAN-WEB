...
<body onload="window.print()">
  ...
  <div id="container">
    ...
    <div id="body">
        <ol type="1">
          <li>Kencana Travel * HANYA agen tiket travel menyediakan pilihan operator yang komprehensif,
            waktu keberangkatan dan harga untuk pelanggan, merupakan keputusan yang mutlak tidak dapat disesuaikan konsumen.</li>
          <li>Waktu keberangkatan yang disebutkan di tiket hanyalah waktu tentatif. Namun
            travel tidak akan meninggalkan sumber sebelum waktu yang disebutkan pada tiket.
            Penumpang diwajibkan untuk memberikan yang berikut pada saat naik travel:
           ...
           <li>Tanggung jawab Kencana Travel meliputi:
            (1) Mengeluarkan tiket yang valid (tiket yang akan diterima oleh operator travel)
            ...
            kerepotan
            Ganti travel: Jika operator travel mengubah jenis travel karena beberapa
            alasannya, Kencana Travel akan mengembalikan jumlah diferensial kepada pelanggan setelah menjadi
            diintimidasi oleh pelanggan dalam 24 jam perjalanan.</li>
            <li> Kebijakan Pembatalan: Untuk SVR Tours & Travels: Maksimal 7 jam sebelum waktu keberangkatan, biaya pembatalan adalah 100,0%. Biaya pembatalan adalah 50,0%. Dan, biaya pembatalan di atas adalah
        10,0%.</li>
        <li>Tanggung jawab Kencana Travel TIDAK termasuk:
        (1) Operator travel membatalkan perjalanan karena alasan yang tidak dapat dihindari
        (2) Bagasi pelanggan hilang / dicuri / rusak
        (3) Operator travel mengubah kursi pelanggan pada menit terakhir
        mengakomodasi seorang wanita / anak
         (4) Pelanggan menunggu di titik keberangkatan yang salah (harap hubungi
        operator travel untuk mengetahui titik boarding yang tepat jika Anda bukan penumpang reguler
        traveler di bus tertentu)
        (5) Operator bus mengubah titik boarding dan / atau menggunakan pick-up
        Jika seseorang membutuhkan pengembalian dana untuk dikreditkan kembali ke rekening banknya, silakan
        tulis rincian kupon tunai Anda ke help desk kami
        * Biaya pengiriman ke rumah (jika ada), tidak akan dikembalikan dalam hal tiket
        ...
        oleh pengguna dll, tiket akan dianggap 'dipesan' selama tiket tersebut dapat menunjukkan
        kendaraan di titik boarding yang akan membawa pelanggan pada keberangkatan travel
        melalui halaman konfirmasi</li>
        </ol>  
    </div>
</div>
